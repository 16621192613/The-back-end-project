...
public class WeixinUtils {
	...
	private static String AppId = "wx298267ec6714cea0";

	private static String secret = "fbbd601e267a493c15e663ca4465525b";
	...
	public static WxUserInfo getUserInfo(String openid) throws Exception {
		...
		Map<String,Object> megMap = JsonUtil.getMap4Json(message);
	...
	public static void createMenu(){
	    ...
	    //output data  
	    String reStr =  HttpUtil.submitJsonPost(url, initMenu()).toString();
	    System.out.println(reStr);
	}
	...
	public static String initMenu(){
		...
		map1.put("name", "预约挂号");
		List<Map<String,Object>> sub1List = new ArrayList<Map<String,Object>>();
		Map<String,Object> subMap1 = new HashMap<String,Object>();
		subMap1.put("type", "view");
		subMap1.put("name", "精准预约");
		subMap1.put("url",CommonUtil.HTTP_PRE+"chooseHospital.htm");
		sub1List.add(subMap1);
		Map<String,Object> subMap2 = new HashMap<String,Object>();
		subMap2.put("type", "view");
		subMap2.put("name", "常见问题");
		subMap2.put("url",CommonUtil.HTTP_PRE+"questions.htm");
		sub1List.add(subMap2);
		map1.put("sub_button", sub1List);
		list.add(map1);
		
		Map<String,Object> map2 = new HashMap<String,Object>();
		map2.put("name", "资讯活动");
		List<Map<String,Object>> sub2List = new ArrayList<Map<String,Object>>();
		Map<String,Object> sub2Map1 = new HashMap<String,Object>();
		sub2Map1.put("type", "view");
		sub2Map1.put("name", "健康养生");
		sub2Map1.put("url",CommonUtil.HTTP_PRE+"health.htm");
		sub2List.add(sub2Map1);
		Map<String,Object> sub2Map2 = new HashMap<String,Object>();
		sub2Map2.put("type", "view");
		sub2Map2.put("name", "医疗知识");
		sub2Map2.put("url",CommonUtil.HTTP_PRE+"knowledge.htm");
		sub2List.add(sub2Map2);
		Map<String,Object> sub2Map3 = new HashMap<String,Object>();
		sub2Map3.put("type", "view");
		sub2Map3.put("name", "最新资讯");
		sub2Map3.put("url",CommonUtil.HTTP_PRE+"news.htm");
		sub2List.add(sub2Map3);
		Map<String,Object> sub2Map4 = new HashMap<String,Object>();
		sub2Map4.put("type", "view");
		sub2Map4.put("name", "平台活动");
		sub2Map4.put("url",CommonUtil.HTTP_PRE+"activity.htm");
		sub2List.add(sub2Map4);
		Map<String,Object> sub2Map5 = new HashMap<String,Object>();
		sub2Map5.put("type", "view");
		sub2Map5.put("name", "天使导医");
		sub2Map5.put("url",CommonUtil.HTTP_PRE+"introduce.htm");
		sub2List.add(sub2Map5);
		map2.put("sub_button", sub2List);
		list.add(map2);
		
		Map<String,Object> map3 = new HashMap<String,Object>();
		map3.put("name", "福利中心");
		List<Map<String,Object>> sub3List = new ArrayList<Map<String,Object>>();
		Map<String,Object> sub3Map1 = new HashMap<String,Object>();
		sub3Map1.put("type", "view");
		sub3Map1.put("name", "个人信息");
		sub3Map1.put("url",CommonUtil.HTTP_PRE+"personalInformation.htm");
		sub3List.add(sub3Map1);
		Map<String,Object> sub3Map2 = new HashMap<String,Object>();
		sub3Map2.put("type", "view");
		sub3Map2.put("name", "积分有礼");
		sub3Map2.put("url",CommonUtil.HTTP_PRE+"dailyTask.htm");
		sub3List.add(sub3Map2);
		Map<String,Object> sub3Map3 = new HashMap<String,Object>();
		sub3Map3.put("type", "view");
		sub3Map3.put("name", "补贴提现");
		sub3Map3.put("url",CommonUtil.HTTP_PRE+"cashAllowance.htm");
		sub3List.add(sub3Map3);
		Map<String,Object> sub3Map4 = new HashMap<String,Object>();
		sub3Map4.put("type", "view");
		sub3Map4.put("name", "就医点评");
		sub3Map4.put("url",CommonUtil.HTTP_PRE+"medicalRecords.htm");
		sub3List.add(sub3Map4);
		Map<String,Object> sub3Map5 = new HashMap<String,Object>();
		sub3Map5.put("type", "view");
		sub3Map5.put("name", "导医医生");
		sub3Map5.put("url",CommonUtil.HTTP_PRE+"chatRoom.htm");
		sub3List.add(sub3Map5);
		map3.put("sub_button", sub3List);
		list.add(map3);
		Map<String,Object> xMap = new HashMap<String,Object>();
		xMap.put("button", list);
		return JsonUtil.getjsonstr(xMap);
	}
	
	public static void main(String[] args){
		
		System.out.print(initMenu());
