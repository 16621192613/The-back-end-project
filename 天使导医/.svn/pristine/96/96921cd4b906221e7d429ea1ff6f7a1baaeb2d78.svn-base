...
public class SystemController extends DSTController{
	...
	public void addVersion(HttpServletRequest request,HttpServletResponse response,String versionCode,String versionName,String content,String force,String downloadUrl,String type) throws Exception{
		sysParameterService.setRequest(request);
		String code="";
		if(type.equals("a"))
			code=CommonUtil.VERSION_PARM_CODE;
		else
			code=CommonUtil.VERSION_PARM_CODE2;
		SysParameter sysParameter = sysParameterService.findSysParameterByCode(code);
	...
	public void getVersion(HttpServletRequest request,HttpServletResponse response,String type) throws Exception{
		SysRetrunMessage srm=new SysRetrunMessage(1l);
		sysParameterService.setRequest(request);
		String code="";
		if(type.equals("a"))
		...
		reMap.put("versionCode", sysParameter.getParamValue());
		reMap.put("versionName", sysParameter.getParamNode());
		reMap.put("content", sysParameter.getParamStr01());
		reMap.put("force", sysParameter.getParamStr02());
		reMap.put("downloadUrl", sysParameter.getParamStr03());
	...
	public void updateJpush(HttpServletRequest request,HttpServletResponse response,String type,String registrationID) throws Exception{
		SysRetrunMessage srm=new SysRetrunMessage(1l);
		agAppDeviceService.setRequest(request);
	...
	public void getPhoneCode(HttpServletRequest request,HttpServletResponse response,String mobile,String code) throws Exception{
		...
		if(code==null || code.trim().equals(""))
			code=RandomCodeUtils.getRandomData(6);
