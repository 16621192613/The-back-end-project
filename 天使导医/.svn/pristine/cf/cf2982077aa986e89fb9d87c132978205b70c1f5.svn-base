...
public class AgDealView {
	...
	private Integer patentFeedBackId;
	
	@Formula("(SELECT a.afbi_id FROM ag_feedback_info a WHERE a.medical_record_id= registration_id)")
	public Integer getPatentFeedBackId() {
		return patentFeedBackId;
	}

	public void setPatentFeedBackId(Integer patentFeedBackId) {
		this.patentFeedBackId = patentFeedBackId;
	}
