                  ...
                  <!-- 标题栏区域 begin-->
                    <div class="ibox-title">
                        ...
                        <div class="ibox-tools">                         
							<button type="button" onclick="toAddChileMenu();" class="btn btn-round btn-info btn-sm fa fa-plus">&nbsp&nbsp增加&nbsp&nbsp</button>
							<button type="button" onclick="delMenu();" class="btn btn-round btn-danger btn-sm fa fa-minus">&nbsp&nbsp删除&nbsp&nbsp</button>
                        </div>
                        <!-- 标题栏工具区域end -->  
                    </div>
                    <!-- 标题栏区域 end-->
                 ...
                 <div class="ibox float-e-margins" style="height:auto">
                  <!-- 标题栏区域 begin-->
                    <div class="ibox-title">
                        ...
                        <!-- 标题栏工具区域begin -->                                          
                        <div class="ibox-tools">                         
                          <button type="button" onclick="save()" class="btn btn-round btn-info btn-sm fa fa-plus">&nbsp&nbsp提交&nbsp&nbsp</button>
                        </div>
                        <!-- 标题栏工具区域end -->  
                    </div>
                    <!-- 标题栏区域 end-->
                       ...
                       <!--条件输入区域begin-->
		                <div class="row" styel="">
				            ...
				            <div class="col-sm-3 text-right">
												...
												<button type="button" class="btn btn-success btn-sm"  onclick="editControlInfo();">
