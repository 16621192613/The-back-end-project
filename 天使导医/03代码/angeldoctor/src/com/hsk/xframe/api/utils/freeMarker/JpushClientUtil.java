...
public class JpushClientUtil {
    ...
    private final static String appKey = "8daa305a57a2fe95621a3c7c";
    private final static String masterSecret = "4c493872004cd346184165b2";
    ...
    public static void main(String[] args){
        if(JpushClientUtil.sendToRegistrationId("18071adc030c8fff976", "测试推送", "测试推送标题", "测试推送内容", "测试推送")==1){
