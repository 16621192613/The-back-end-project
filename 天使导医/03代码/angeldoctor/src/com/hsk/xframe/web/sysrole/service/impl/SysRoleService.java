...
public class SysRoleService extends DSTService implements ISysRoleService {
	...
	@Override
	public List<Map<String, Object>> getSysRoleInfoList() throws HSKException {
		List<Map<String, Object>> reList = new ArrayList<Map<String, Object>>();
		SysRoleInfo sysRoleInfo = new SysRoleInfo();
		try {
			List<SysRoleInfo> roleList= this.getList(sysRoleInfo);
			if(roleList!= null && roleList.size() >0){
				for(SysRoleInfo roleInfo : roleList){
					Map<String,Object> reMap = new HashMap<String,Object>();
					reMap.put("id", roleInfo.getSroleId());
					reMap.put("name", roleInfo.getMenuName());
					reMap.put("isAdmin", roleInfo.getIsAdmin());
					reList.add(reMap);
				}
			}
